<x-app-layout>
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6 space-y-4 sm:space-y-0 sm:flex sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Certificate Categories</h1>
                <p class="mt-1 text-sm text-gray-500">Manage and organize certificate categories</p>
            </div>
            <a href="{{ route('admin.certificate-categories.create') }}" 
                class="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($categories as $category)
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4">
                                    <img src="{{ asset('storage/' . $category->certificate_template)}}" alt="" class="w-24">
                                </td>
                                <td class="px-6 py-4 text-right text-sm font-medium">
                                    <a href="{{ route('admin.certificate-categories.edit', $category) }}" 
                                        class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mr-2">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <img src="{{ asset('storage/' . $category->certificate_template)}}" alt="" class="w-full">
                            </div>
                        </div>
